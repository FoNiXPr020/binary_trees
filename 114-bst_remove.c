...
bst_t *inorder(bst_t *root);
bst_t *delete(bst_t *root, bst_t *node);
bst_t *remove_recursive(bst_t *root, bst_t *node, int value);
bst_t *bst_remove(bst_t *root, int value);

/**
 * inorder - Finds the inorder successor of a node in a binary search tree.
 * @root: A pointer to the root node of the BST.
 *
 * Return: The inorder successor of the @root node.
 */
